...
class PaymentTest extends TestCase 
{
     ...
     * @return void
     */
    public function test_kwik_can_fetch_merchant_cards(): void
    {
        $kwik = new Kwik();
        ...
        $merchant_cards = $kwik->getMerchantCards(); 
        $this->assertNotNull($merchant_cards);
        $this->assertIsArray($merchant_cards);
        $this->assertNotEmpty($merchant_cards);
